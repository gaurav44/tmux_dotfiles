...
session_root "~/Desktop/liggghts-unstable/liggghts-src"  # Replace with your desired directory path.

# Create session with specified name if it does not already exist.
if initialize_session "liggghts_unstable"; then

  # Create a window for code editing.
  new_window "liggghts_unstable"
